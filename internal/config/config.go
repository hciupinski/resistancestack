...
var defaultLineComments = map[string]string{
	...
	"deployment.profile": "Deployment profile used by wizard and audit. Options: vps-nginx, docker-compose, " +
		"reverse-proxy, node, dotnet, python, fastapi, django, php, laravel, wordpress, static-frontend, small-saas, apache, caddy.",
	...
	"observability.panel_bind":                               "Local bind address for the Grafana observability UI.",
	"observability.local_data_dir":                           "Directory used for observability data, credentials, generated configs, and snapshots.",
	"observability.snapshot_interval":                        "Interval used for Resistack snapshot generation.",
	"observability.retention_days":                           "Days of Loki log retention kept on the host.",
	"observability.grafana_assets_path":                      "Optional local folder with Grafana dashboards/ and alerting/ provisioning files deployed with observability.",
